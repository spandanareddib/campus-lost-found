// ─── Vision API — Gemini 2.0 Flash (REST v1beta, no SDK) ─────────────────────
//
...
// Model name rules (learned the hard way):
//   ✓  gemini-2.0-flash          — works on v1beta
//   ✓  gemini-1.5-flash          — works on v1beta (no -latest suffix!)
//   ✗  gemini-1.5-flash-latest   — NOT_FOUND on v1beta
//   ✗  gemini-1.5-flash          — NOT_FOUND on stable v1
const GEMINI_URL =
...
export async function analyseImage(imageFile) {
  ...
  console.log('[visionApi] Sending to gemini-2.0-flash (v1beta)…', {
    url: GEMINI_URL,
    mimeType,
